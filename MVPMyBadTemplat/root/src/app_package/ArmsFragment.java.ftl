...
import com.shared.skateboard.skateboard.base.BaseDefaultFragment;
...
<@gb.fileHeader />
public class ${pageName}Fragment extends BaseDefaultFragment<${pageName}Presenter> implements ${pageName}Contract.View{
    ...
    public View initView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
     ...
     @Override
      protected void onLazyLoadData(Bundle savedInstanceState) {
